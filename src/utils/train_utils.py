...
TASK_VIZ_SPECS = {
    Tasks.SPATIAL_COORDINATION: [Specs.SYMETRY_OFFSET, Specs.SET_SIZE],  
    Tasks.SPATIAL_FREE_RECALL: [Specs.LIST_LENGTH, Specs.SERIAL_POSITION],  
    Tasks.SPATIAL_INTEGRATION: [Specs.PART_SIZE],
    Tasks.SPATIAL_MEMORY_UPDATING: [Specs.SET_SIZE, Specs.SERIAL_POSITION],
    Tasks.SPATIAL_TASK_SWITCHING: [], 

    Tasks.VISUAL_ITEM_RECOGNITION: [Specs.RETENTION_INTERVAL, Specs.SERIAL_POSITION],
    Tasks.VISUAL_SERIAL_RECALL: [Specs.LIST_LENGTH, Specs.SERIAL_POSITION],
    Tasks.VISUAL_SERIAL_RECOGNITION: [Specs.LIST_LENGTH, Specs.DISTRACTOR_DIFF, Specs.SERIAL_POSITION],

    Tasks.CHANGE_DETECTION_COLOR: [Specs.SET_SIZE, Specs.RETENTION_INTERVAL],
    Tasks.CHANGE_DETECTION_ORIENTATION: [Specs.SET_SIZE, Specs.RETENTION_INTERVAL],
    Tasks.CHANGE_DETECTION_SIZE: [Specs.SET_SIZE, Specs.RETENTION_INTERVAL],
    Tasks.CHANGE_DETECTION_GAP: [Specs.SET_SIZE, Specs.RETENTION_INTERVAL],
    Tasks.CHANGE_DETECTION_CONJ: [Specs.SET_SIZE, Specs.RETENTION_INTERVAL, Specs.CONJ_GT],
}
